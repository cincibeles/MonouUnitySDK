...
var ASM_CONSTS = {
  2867136: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 2867197: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 2867261: function() {return Module.webglContextAttributes.powerPreference;},  
 2867319: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 2867374: function($0) {performance.now = function() { return $0; };},  
 2867422: function($0) {performance.now = function() { return $0; };},  
 2867470: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  var SharedData = {gameKey:"",waiting:false,secure:false,generateSignature:async function (secret, bodyStr) {
  ...
  function _MonouGameScraper_Advance(delta){ SharedData.send(SharedData.gameKey, "advance", delta, SharedData.generateSignature) }

  function _MonouGameScraper_Advertise(taskId){
  ...
  function _MonouGameScraper_AdvertiseRewarded(taskId){
  ...
  function _MonouGameScraper_Finish(score){ SharedData.send(SharedData.gameKey, "finish", score, SharedData.generateSignature) }

  function _MonouGameScraper_Init(kPointer){
  ...
  function _MonouGameScraper_Sell(amount, taskId){
  ...
  function _MonouGameScraper_Start(){ SharedData.send(SharedData.gameKey, "start", false, SharedData.generateSignature) }
...
var asmLibraryArg = {
  ...
  "MonouGameScraper_Advance": _MonouGameScraper_Advance,
  "MonouGameScraper_Advertise": _MonouGameScraper_Advertise,
  "MonouGameScraper_AdvertiseRewarded": _MonouGameScraper_AdvertiseRewarded,
  "MonouGameScraper_Finish": _MonouGameScraper_Finish,
  "MonouGameScraper_Init": _MonouGameScraper_Init,
  "MonouGameScraper_Sell": _MonouGameScraper_Sell,
  "MonouGameScraper_Start": _MonouGameScraper_Start,
...
unexportedRuntimeFunction('SharedData', false);
unexportedRuntimeFunction('SharedData__user', false);
